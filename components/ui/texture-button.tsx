...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      glassyBlue:
        "w-full rounded-full border border-blue-400/30 bg-gradient-to-b from-blue-300/30 to-transparent p-[1.5px] shadow-[0_12px_40px_-8px_rgba(37,99,235,0.7)] transition duration-300 ease-in-out hover:shadow-[0_16px_48px_-8px_rgba(37,99,235,0.8)]",
    },
    size: {
      sm: "rounded-[6px]",
  ...
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        ...
        glassyBlue:
          "gap-2 rounded-full w-full h-full flex items-center justify-center bg-gradient-to-b from-[#3b82f6] to-[#1d4ed8] text-white font-medium tracking-wide transition duration-300 ease-in-out hover:from-[#60a5fa] hover:to-[#2563eb] active:from-[#2563eb] active:to-[#1e40af] shadow-[inset_0_2px_4px_rgba(255,255,255,0.4),inset_0_-4px_8px_rgba(0,0,0,0.2),0_2px_4px_rgba(0,0,0,0.1)] drop-shadow-sm",
      },
      size: {
